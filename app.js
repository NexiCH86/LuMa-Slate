...
window.addEventListener('luma-update-error',()=>showUpdateToast('Update konnte nicht geladen werden. WLAN prüfen und erneut öffnen.'));
showVersionBadge();
setTimeout(showVersionBadge,1200);
